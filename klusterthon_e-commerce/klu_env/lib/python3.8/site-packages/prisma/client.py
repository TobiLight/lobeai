...
SCHEMA_PATH = Path('/home/tobii/klusterthon_e-commerce/prisma/schema.prisma')
...
class Prisma:
    ...
    prompt: 'actions.PromptActions[models.Prompt]'
    databaseconnection: 'actions.DatabaseConnectionActions[models.DatabaseConnection]'
    ...
    def __init__(
        ...
        *,
        ...
        self.prompt = actions.PromptActions[models.Prompt](self, models.Prompt)
        self.databaseconnection = actions.DatabaseConnectionActions[models.DatabaseConnection](self, models.DatabaseConnection)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgresql://postgres:admin123.@localhost:5432/labeai', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    ...
    prompt: 'PromptBatchActions'
    databaseconnection: 'DatabaseConnectionBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.prompt = PromptBatchActions(self)
        self.databaseconnection = DatabaseConnectionBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class DatabaseConnectionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
